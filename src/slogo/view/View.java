...
public class View implements UserActionObserver {
  ...
  public View(Turtle model, InputObserver observer, Stage primaryStage,
      EventHandler<ActionEvent> handler, Workspace modelWorkspace, String input) {
  ...
  public void startProgram() {
    ...
    logAndWorkspace.setBackground(
        new Background(new BackgroundFill(Color.ORANGE, CornerRadii.EMPTY, Insets.EMPTY)));
    logAndWorkspace
        .setMinWidth(Double.parseDouble(mySettings.getString("LogAndWorkSpaceMinWidth")));
...
//        logAndWorkspace.setMaxWidth(Double.MAX_VALUE);
    ...
    mainContent
        .setPadding(new Insets(Double.parseDouble(mySettings.getString("MainContentPadding"))));

    VBox everything = new VBox(macOSMenuBar, topBar, mainContent);
    everything.setVgrow(mainContent, Priority.ALWAYS);
    everything.setBackground(
  ...
  private WorkspaceDisplay createWorkSpace() {
    ...
    workspace.setBackground(
        new Background(new BackgroundFill(Color.CHOCOLATE, CornerRadii.EMPTY, Insets.EMPTY)));
    return workspace;
  }
...
//        input.setMaxHeight(Double.parseDouble(mySettings.getString("InputConsoleMaxHeight")));
  ...
  public void receiveAction(String action, Object[] args) {
    ...
    try {
      ...
      error = mySettings.getString("MethodNotImplemented") + methodName + "\t" + Arrays
          .toString(paramTypes);
